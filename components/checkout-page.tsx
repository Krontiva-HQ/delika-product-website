                  ...
                  <div className="flex gap-2 overflow-x-auto py-1 scrollbar-hide">
                    {branchDetails?._menutable?.map(category => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-sm whitespace-nowrap transition-all ${selectedCategory === category.foodType
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {currentCategory?.foods.map(item => {
                    ...
                    return (
                      <div
                        key={item.name}
                        className={`flex gap-4 p-4 rounded-2xl border group transition-all duration-300 ${!item.available
